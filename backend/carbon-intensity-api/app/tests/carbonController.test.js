const { getCarbonData, addCarbonData } = require('../controllers/carbonIntensity.controller');
...
describe('addCarbonData', () => {
    ...
    it('should return 400 if required fields are missing', () => {
        req.body = { to: '2025-01-01T00:30Z' }; // Missing 'from'
    ...
    it('should return 201 and add data if valid', () => {
        ...
        expect(mockData).toContainEqual(req.body);
    });
});